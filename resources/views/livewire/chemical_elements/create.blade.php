                    ...
                    <div class="mt-2">
                        ...
                        <form>
                            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                <div class="flex">
                                    <h3 class="items-center pt-4 pr-4">Nombre</h3>
                                    <div class="mb-4">
                                        <input type="text" class="sshadow appearance-none border w-full rounded-full" placeholder="Name" wire:model="name">
                                        @error('name') <span class="text-red-500">{{ $message }}</span>@enderror
                                    </div>
                                </div>
                                <div class="flex">
                                    <h3 class="items-center pt-4 pr-4">Codigo</h3>
                                    <div class="mb-4">
                                        <input type="text" class="shadow appearance-none border w-full rounded-full" wire:model="chemical_code"
