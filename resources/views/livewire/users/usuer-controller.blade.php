    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="py-4">
            <div class="rounded-full bg-green-100 px-4 pl-6 py-2 border w-full">
                <h3 class="text-center px-2 py-2 ">USUARIO </h3>
            </div>
        </div>
        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
            ...
            <table class="table-fixed w-full">
                ...
                <tr class="bg-gray-300">
                    ...
                    <th class="px-4 py-2">Direccion de Correo</th>
                ...
                @foreach($Usuario as $usu)
                    <tr>
                        <td class="border px-4 py-2">{{ $usu->name }}</td>
                        <td class="border px-4 py-2">{{ $usu->email }}</td>
                        <td class="border px-4 py-2">
                            <div class="flex justify-between">
                                <div class="">
                                    <button wire:click="edit({{ $usu->id }})"
                                            class="bg-green-700 text-white font-bold py-2 px-4"><i class="fa-solid fa-pen-to-square"></i></button>
                                </div>
                                <div>
                                    <button onclick="confirmdelete()" wire:click="delete({{ $usu->id }})"
