        ...
        <div class="relative inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6">
            <div>
                <div class="justify-center   rounded-full bg-gray-100">
                    <h3 class="text-center px-2 py-2 bg-green-100 rounded-full">NUEVO TIPO DE TRABAJO</h3>
                </div>
                <form>
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div class="flex">
                            ...
                            <div class="mb-4">
                                <input type="text" class="sshadow appearance-none border w-full rounded-full" placeholder="descripcion del trabajo" wire:model="type_job">
                                @error('type_job') <span class="text-red-500">{{ $message }}</span>@enderror
                            </div>
                        </div>
                    </div>
