                    ...
                    <div class="mt-2">
                        <form>
                            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                ...
                                <select wire:model="supply_id" class="form-control">
                                ...
                                <div class="">
                                    <div class="mb-4">
                                        <input type="text" class="sshadow appearance-none border w-full" placeholder="Porcentaje" wire:model="percentage">
