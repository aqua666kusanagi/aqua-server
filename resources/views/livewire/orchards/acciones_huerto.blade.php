 <div id="menu_navigation">
        ...
        <ul>
            ...
            <li><a id="active4" class="hoverr" href="{{route('dias_trabajo',$datos_orchard->id)}}">Dias_a_Trabajar</a></li>--}}
            <li><a id="active5" class="hoverr" href="{{url('calendar')}}"  onclick="activi()">Actividades</a></li>
