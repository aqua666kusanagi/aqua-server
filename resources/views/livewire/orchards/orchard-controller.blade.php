    ...
    <div class=" mx-auto sm:px-6 lg:px-8 ">
        <div class="padd bg-white overflow-hidden shadow-xl sm:rounded-lg px- py-4">
            ...
            <div class="padd grid gap-4 grid-cols-3 ">
                ...
                <div class="subitem ring-4 ring-green-500 ring-opacity-50 shadow-lg shadow-cyan-500/50" wire:click="edit({{ $orchards->id }})">
                    <div class="flexin">
                    ...
                    <div class="mb-4 padd">
                        <div class="flex justify-between">
                            <div>
                                <button wire:click="edit({{ $orchards->id }})" class="bg-green-700 text-white font-bold py-2 px-4 rounded-full"><i class="fa-solid fa-pen-to-square"> EDITAR</i></button>
                            </div>
                            <div>
