        ...
        <header class="relative z-20 flex flex-none items-center justify-between border-b border-gray-200 py-4 px-6">
            <div>
                <h1 class="text-lg font-semibold leading-6 text-gray-900">
                    ...
                    <time datetime="2022-01-22" class="hidden sm:inline">Mes-Dia, Año</time>
                </h1>
                <p class="mt-1 text-sm text-gray-500">Dia de la semana</p>
            </div>
                    ...
                    <div class="relative">
                        ...
                        <div id="contenido_dentro" class="focus:outline-none absolute right-0 mt-3 w-36 origin-top-right overflow-hidden rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5"    role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
                            <div class="py-1" role="none">
                                ...
                                <a href="#" onclick="item_nav()" class="text-gray-700 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-0">Day view</a>
                                <a href="#" onclick="item_nav()" class="text-gray-700 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-1">Week view</a>
                                <a href="#" onclick="item_nav()" class="text-gray-700 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-2">Month view</a>
                                <a href="#" onclick="item_nav()" class="text-gray-700 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-3">Year view</a>
                            </div>
                        </div>
