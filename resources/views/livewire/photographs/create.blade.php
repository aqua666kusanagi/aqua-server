                                            ...
                                            <div class="rounded-lg col-span-6  ">
                                                ...
                                                <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md ">
                                                    <div class="space-y-1 text-center items-center">
                                                        @if ($path)
                                                        <img src="{{method_exists($path, 'TemporaryUrl')?$path->TemporaryUrl():asset("storage/photographs". $path)}}" alt="preview image" width="100px" height="100px">
                                                        @else
                                                        ...
                                                        <div class="flex text-sm text-gray-600">
                                                            <label for="file-upload" class="relative cursor-pointer bg-white rounded-md font-medium text-indigo-600 hover:text-indigo-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
                                                                ...
                                                                <input id="file-upload" name="file-upload" type="file" class="sr-only" class="sshadow appearance-none border rounded-full" placeholder="image" wire:model="path">
                                                            </label>
