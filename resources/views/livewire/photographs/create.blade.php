        ...
        <div class="relative inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6">
            <div>
                ...
                <div class="bg-white space-y-6  px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div class="flex">
                        <h3 class="items-center pt-4 pr-4">Huerto</h3>
                    ...
                    <div class="flex">
                        <h3 class="items-center pt-4 pr-4">Fecha</h3>
                        <div class=" rounded-full  px-4 pl-6 py-2 border w-full">
                            <input type="date" class=" rounded-full  px-4 pl-6 py-2 border w-full" placeholder="" wire:model="date">
