        ...
        <div class="relative inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6">
            <div>
                <div class="justify-center   rounded-full bg-gray-100">
                    <h3 class="text-center px-2 py-2 bg-green-100 rounded-full">NUEVA TIPO DE FOTOGRAFIA</h3>
                </div>
                ...
                <div class="bg-white space-y-6  px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div class="flex">
                        ...
                        <div class=" px-4 pl-6 py-2 w-full">
                            <input type="text" class=" rounded-full  px-4 pl-6 py-2 border w-full" placeholder="descripcion" wire:model="type_photograph">
                            @error('type_photograph') <span class="text-red-500">{{ $message }}</span>@enderror
                        </div>
                    </div>
