                    ...
                    <div class="mt-2">
                        ...
                        <form>
                            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                ...
                                <div class="">
                                    <div class="mb-4">
                                        <input type="text" class="sshadow appearance-none border w-full" placeholder="Nombre" wire:model="name">
                                ...
                                <div class="">
                                    <div class="mb-4">
                                        <input type="text" class="sshadow appearance-none border w-full" placeholder="Numero De Registro" wire:model="registry_number">
                                ...
                                <div class="">
                                    <div class="mb-4">
                                        <input type="text" class="sshadow appearance-none border w-full" placeholder="Hoja De Datos" wire:model="data_sheet">
                                ...
                                <div class="">
                                    <div class="mb-4">
                                        <input type="text" class="sshadow appearance-none border w-full" placeholder="Termino De Seguridad" wire:model="security_term">
