                    ...
                    <div class="mt-2">
                        ...
                        <form>
                            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                ...
                                <select wire:model="workday_id" class="form-control">
                                    <option value="">--Dia de trabajo--</option>
                                    @foreach($workdays as $work)
                                        <option type="int" value="{{$work->id}}">{{$work->date_work}}
                                        </option>
                                    @endforeach
                                </select>

                                <select wire:model="application_mode_id" class="form-control">
                                ...
                                <div class="">
                                    <div class="mb-4">
                                        <input type="text" class="sshadow appearance-none border w-full" placeholder="Notas" wire:model="note">
