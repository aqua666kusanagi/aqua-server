...
<div class="h-screen pb-14 bg-right bg-cover" style="background-image:url({{asset('images/bg.svg')}});">
    ...
    <div class="container pt-24 md:pt-48 px-6 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div class="flex flex-col w-full xl:w-2/5 justify-center lg:items-start overflow-y-hidden">
            <h1 class="my-4 text-3xl md:text-4xl text-purple-800 font-bold leading-tight text-center md:text-left slide-in-bottom-h1">GeoReferenzacion y Registro Fenologico de cultivos de Aguacate</h1>
        </div>
