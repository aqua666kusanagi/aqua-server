                ...
                <div class="w-full flex items-center justify-between">
                    ...
                    @if (Route::has('login'))
                        <div class="hidden fixed top-4 right-0 px-6 py-4 sm:block">
                            ...
                            @else
                                <a href="{{ route('login') }}" class="text-sm text-green-600 dark:text-green-600 underline font-bold">Log in</a>

                                @if (Route::has('register'))
                                    <a href="{{ route('register') }}" class="ml-4 text-sm text-green-600 dark:text-green-600 underline font-bold">Register</a>
                                @endif
                            @endauth
                        </div>
                    @endif
